...
use Yiifabric\Authorization\BaseManager;
use Yiifabric\Authorization\Item;
...
{
    /**
     * @var \Yiifabric\Authorization\ManagerInterface|BaseManager
     */
    protected $auth;

    /**
     * @return \Yiifabric\Authorization\ManagerInterface
     */
    ...
    public function testGetRule()
    {
        ...
        $this->assertInstanceOf('Yiifabric\Authorization\Rule', $rule);
    ...
    public function testGetRolesByUser()
    {
        ...
        $this->assertContains('testDefaultRole', array_keys($roles));
    }
